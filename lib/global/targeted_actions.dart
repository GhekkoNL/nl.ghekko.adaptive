...
class TargetedActionScope extends StatefulWidget {
  const TargetedActionScope({super.key, required this.child, required this.shortcuts});

  final Widget child;
  final Map<LogicalKeySet, Intent> shortcuts;

  @override
  State createState() => TargetedActionScopeState();
}

class TargetedActionScopeState extends State<TargetedActionScope> {
  late TargetedActionRegistry registry;
  Map<LogicalKeySet, Intent> mappedShortcuts = <LogicalKeySet, Intent>{};

  @override
  void initState() {
    super.initState();
    registry = TargetedActionRegistry();
  ...
  Widget build(BuildContext context) {
    return Provider<TargetedActionRegistry>.value(
      value: registry,
      child: Shortcuts(
...
class TargetedActionBinding extends StatefulWidget {
  ...
  @override
  State createState() => TargetedActionBindingState();
}

class TargetedActionBindingState extends State<TargetedActionBinding> {
  final GlobalKey _subtreeKey = GlobalKey(debugLabel: 'Targeted Action Binding');

  @override
  Widget build(BuildContext context) {
    Provider.of<TargetedActionRegistry>(context).addTarget(_subtreeKey);
  ...
  @override
  void deactivate() {
    Provider.of<TargetedActionRegistry>(context, listen: false).targetKeys.remove(_subtreeKey);
    super.deactivate();
  }
}
...
class TargetedActionRegistry {
  TargetedActionRegistry()
...
class _TargetedAction extends Action<_TargetedIntent> {
  ...
  final TargetedActionRegistry registry;
